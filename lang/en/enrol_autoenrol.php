...
$string['enrolperiod_help'] = 'Date until the enrolment is valid or length of time that the enrolment is valid, starting with the moment the user enrols themselves. If disabled, the enrolment duration will be unlimited.';
...
$string['durationfortime'] = 'for specified amount of time';
$string['durationuntildate'] = 'until specified date';
$string['durationdisabled'] = 'disabled';
