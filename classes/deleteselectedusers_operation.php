...
/**
 * A bulk operation for the autoenrol enrolment plugin to delete selected users enrolments.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_autoenrol_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_autoenrol');
    }
    ...
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_autoenrol');

        return new enrol_autoenrol_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/autoenrol:unenrol", $manager->get_context())) {
            return false;
        }
